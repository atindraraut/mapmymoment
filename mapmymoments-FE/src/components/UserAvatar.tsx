...
import { UserAuthInfo } from '@/lib/api';
...
const UserAvatar = ({ 
  ...
  return (
    <div className="relative">
      ...
      {/* Full Profile Modal for Desktop */}
      {isProfileModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
            {/* Header */}
            <div className="bg-gradient-to-r from-primary to-accent px-6 py-4 text-white flex items-center justify-between">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-lg shadow-sm p-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <button 
                          onClick={() => authInfo?.has_google ? onUnlinkGoogle?.() : onLinkGoogle?.()}
                          className="w-full flex items-center justify-between py-3 px-4 text-left hover:bg-gray-50 rounded-lg transition-colors"
                        >
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <span className="text-gray-700">
                                {authInfo?.has_google ? 'Unlink Google Account' : 'Link Google Account'}
                              </span>
                              {authInfo?.has_google && (
